// Collection progress controller. Owns progress UI state, stage rendering, counters, logs, and completion/error transitions.
import { getStageTitle, resolveStageId } from "./constants.js";
import { createCollectionSummary } from "./summary.js";
import { createStageLogManager } from "./stageLog.js";
import { getStatusInfo } from "./formatters.js";

// Drives the popup collection panel: availability, progress summary, stage log, status, and collect button actions.
export function createCollectionController({
  ...
  // Updates compact collection counters from the aggregated summary state.
