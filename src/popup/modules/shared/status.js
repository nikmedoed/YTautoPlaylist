// Shared popup status controller. Shows, hides, and times transient status messages.
...
// Controls popup status text, error styling, progress bar state, and auto-clear timers.
