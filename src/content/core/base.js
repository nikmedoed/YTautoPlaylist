...
export const inlinePlaylistState = {
  currentListId: null,
  currentListName: "",
  videoIds: new Set(),
  orderedVideoIds: [],
...
export const STYLE_ID = "yta-controller-style";
export const CARD_MARK = "data-yta-enhanced";
export const THUMB_HOST_CLASS = "yta-thumb-host";
export const CARD_OVERLAY_HOST_CLASS = "yta-card-overlay-host";
export const INLINE_BUTTON_OVERLAY_CLASS = "yta-inline-overlay";
export const ADD_BUTTON_CLASS = "yta-inline-add";
export const ADD_BUTTON_DONE_CLASS = "yta-inline-add--done";
...
export const PAGE_COLLECTION_LIMIT = 5000;
export const PAGE_SCROLL_MAX_LOOPS = 120;
export const PAGE_SCROLL_IDLE_LIMIT = 4;
export const PAGE_SCROLL_DELAY = 420;
...
export function canHandlePlaybackActions() {
...
export function getContextCapabilities(context = determinePageContext()) {
...
// Safe wrapper around chrome.runtime.sendMessage. Content scripts can be
// invalidated during YouTube navigation, so recoverable disconnects resolve
// to null instead of surfacing as unhandled promise rejections.
